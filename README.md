...
## Versiunea 05.09.2026-2

- Panoul de arhivare în masă este acum primul element, pe toată lățimea, în pagina **Verificare**.
- Arhivarea MARO include numere cu MARO și eventual DISPĂRUT, dar protejează ACTIV, SAFE și ROȘU.
- Arhivarea ROȘU include și combinațiile MARO + ROȘU, dar protejează orice număr ACTIV sau SAFE.
